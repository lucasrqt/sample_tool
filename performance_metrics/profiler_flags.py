...
PERFORMANCE_METRICS_NSIGHT_CLI = {
    ...
    # keep in mind that it is not the directly flag related for these ones
...
METRICS_NSIGHT_CLI_SM70 = {**QUANTITATIVE_METRICS_NSIGHT_CLI, **PERFORMANCE_METRICS_NSIGHT_CLI}
