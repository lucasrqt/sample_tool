...
class HardenedIdentity(torch.nn.Identity):
    ...
    __PROFILES = {
        configs.VIT_BASE_PATCH16_224: (-35.710975646972656, 18.718002319335938),
        configs.VIT_BASE_PATCH16_384: (-55.64329147338867, 21.802248001098633),
        configs.VIT_BASE_PATCH32_224_SAM: (-32.792327880859375, 4.56120491027832),
        ...
        configs.VIT_LARGE_PATCH14_CLIP_224: (-231.32127380371094, 52.204036712646484),
